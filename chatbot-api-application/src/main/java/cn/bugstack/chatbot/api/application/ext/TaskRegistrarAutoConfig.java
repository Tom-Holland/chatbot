...
import cn.bugstack.chatbot.api.application.job.ChatbotSchedule;
...
public class TaskRegistrarAutoConfig implements EnvironmentAware, SchedulingConfigurer {
    ...
    public void configureTasks(ScheduledTaskRegistrar taskRegistrar) {
        ...
        for (String groupKey : taskGroups) {
            ...
            // 添加任务
            taskRegistrar.addCronTask(new ChatbotSchedule(groupName, groupId, cookie, openAiKey, zsxqApi, openAI, silenced), cronExpression);
        }
    }
